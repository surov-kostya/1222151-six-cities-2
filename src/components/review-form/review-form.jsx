    ...
    return (
      <form ref={this._formRef} className="reviews__form form" onSubmit={(event) => {
        ...
        <div className="reviews__rating-form form__rating">
          <input className="form__rating-input visually-hidden" disabled={application.isFormBlocked} name="rating" value="5" id="5-stars" type="radio" onChange={this._handleRatingSet} />
          ...
          <input className="form__rating-input visually-hidden" disabled={application.isFormBlocked} name="rating" value="4" id="4-stars" type="radio" onChange={this._handleRatingSet} />
          ...
          <input className="form__rating-input visually-hidden" disabled={application.isFormBlocked} name="rating" value="3" id="3-stars" type="radio" onChange={this._handleRatingSet} />
          ...
          <input className="form__rating-input visually-hidden" disabled={application.isFormBlocked} name="rating" value="2" id="2-stars" type="radio" onChange={this._handleRatingSet} />
          ...
          <input className="form__rating-input visually-hidden" disabled={application.isFormBlocked} name="rating" value="1" id="1-star" type="radio" onChange={this._handleRatingSet} />
